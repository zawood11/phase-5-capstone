...
RSpec.describe "/workouts", type: :request do
  ...
  # WorkoutsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get workouts_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Workout" do
        expect {
          post workouts_url,
               params: { workout: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Workout" do
        expect {
          post workouts_url,
               params: { workout: invalid_attributes }, as: :json
        }.to change(Workout, :count).by(0)
      end

      it "renders a JSON response with errors for the new workout" do
        post workouts_url,
             params: { workout: invalid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested workout" do
        workout = Workout.create! valid_attributes
        patch workout_url(workout),
              params: { workout: new_attributes }, headers: valid_headers, as: :json
        workout.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested workout" do
      workout = Workout.create! valid_attributes
      expect {
        delete workout_url(workout), headers: valid_headers, as: :json
      }.to change(Workout, :count).by(-1)
    end
  end
end
